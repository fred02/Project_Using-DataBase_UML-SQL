...
/**
 * Classe Detecteur qui permet de scrutter les boutons et la molette et verifie
 * tout changment d'etat.
 *
 * @version 3.0
 * @author Rafik gharsalli , Olivier Charrier , Fahd Kacem copyright (c) 2012
 * UQAM All Rights Reserved
 */
public class Detecteur implements Commandes, Observateur {
    ...
    /**
     *
     * Active l'action toute les period en secondes. L'action se repete a
     * l'infini sans tant que la method scruter n'est pas utilis�
     */
    ...
    /**
     * Permet de scrutter le bouton Start de l'objet Clavier et verifie s'il y'a
     * un changemet d'etat .
     */
    ...
    /**
     * Permet de scruter le bouton Stop de l'objet Clavier et verifie s'il y'a
    ...
    /**
     * Permet de scruter la molette de l'objet Molette et verifie s'il y'a un
     * changement d'etat .
     */
